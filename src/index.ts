...
console.log(true)
  ...
  console.log(["1", "2", "3", ])
      ...
      // 5) object supongamos que quiero almacenar un conjunto de datos 
  ...
  console.log({
      ...
      // 6) Las Variables son cajas para almacenar datos para usarlos despues
...
console.log(result);
   ...
   let verifica = passwordDB === inputUser;
    ...
    // 6) Ahora vamos a agregar un CONDICIONAL segun el password 
    // sea true o false
    // Lo haremos con palabras claves reservada
     if (verifica === true) {
      ...
      if (score >60) {
        ...
        // Ahora veremos otra CONDICIONAL que es switch
      ...
      // 8) Ahora veremos otra que son BUCLES O ITERADORES
      ...
      let count = 1; // Modificar este valor y se vera por console log
        // al costado de Cant de Bucles el circulito de la cant de loops
      //podemos reemplazar count = count -1 cont + 1 por count-- o por count++      }
       while(count < 5 ) {
          console.log(count);
          count++
       }
...
let names = ["Jose", "Claudia", "Pablo",];
      ...
      // 9) Ahora empezamos a ver FUNCIONES
      ...
      // ahora armaremos la funcion sumar
      //por default cuand declaramos algo asume any type
       ...
       //para sacar las vivoritas rojas de n1 y n2 y que solo admita numeros
       //debemos declarar su type number y vemos que Pedro tiene vivorita roja
